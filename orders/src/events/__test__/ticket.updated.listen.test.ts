...
const setup = async () => {
    ...
    const ticketListener = {
        ...
        queueGroupName: 'ticket-updated-for-orders',
...
describe("ticket update listener test", () => {
    ...
    it('should recieve data from ticket update listener', async() => {
        ...
        expect(ticketListener.subject).toBe(Subject.TickerUpdated)
        expect(ticketListener.queueGroupName).toBe('ticket-updated-for-orders')
